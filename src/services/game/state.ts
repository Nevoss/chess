...
const state: GameState = {
  ...
  pieces: [
    ...
    { id: "white-queen", type: "queen", color: "white", position: ["D", "5"], hasMoved: false },
    { id: "white-king", type: "king", color: "white", position: ["D", "4"], hasMoved: false },
    ...
    { id: "black-pawn-5", type: "pawn", color: "black", position: ["E", "4"], hasMoved: false },
    { id: "black-pawn-6", type: "pawn", color: "black", position: ["F", "3"], hasMoved: false },
    { id: "black-pawn-7", type: "pawn", color: "black", position: ["F", "5"], hasMoved: true },
